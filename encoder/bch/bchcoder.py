...
class BchCoder:
    ...
    def __init__(self, n, d, r_poly, g_poly):
        ...
        :param r_poly: primary polynomial or field polynomial
        :param g_poly: generation polynomial
        ...
        # Note: mathutils.order function only effective for n = 2^m - 1
    ...
    def decode(self, msg_poly):
        ...
        for i in range(self.d - 1):
            s.append((Poly(msg_poly.eval(alpha ** i), alpha) % self.r_poly).trunc(self.q))
